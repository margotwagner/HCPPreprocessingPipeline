...
StudyFolder="${HOME}/projects/hcp/Pipelines_ExampleData" #Location of Subject folders (named by subjectID)
Subjlist="100307" #Space delimited list of subject IDs
EnvironmentScript="${HOME}/projects/hcp/HCPPIPEDIR/Examples/Scripts/SetUpHCPPipeline.sh" #Pipeline environment script
